...
export function Footer (){
   ...
   <Image src="/castelos.png"width= {80} height= {80} alt="Capa do álbum Castelos e Ruinas"/>
   <div className="flex flex-col ">
    <strong className="font-normal">Castelos&Ruínas</strong>
    <span className="text-xs text-zinc-400">BK, Sain</span>
   </div>
   </div>
